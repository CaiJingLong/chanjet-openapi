...
import { createXjllbApi } from '../../../src/api/bb/xjllb.js';
...
describe('createXjllbApi', () => {
  ...
  it('客户端抛错时透传', async () => {
    ...
    await expect(
      api.cashFlow({ bookid: 'b1', period: '202608', isQuarter: 'false' }),
